...
{
    public class ProcessItem_FindCtrlByCtrlClass : IProcessItem
    {
        ...
        public ProcessItem_FindCtrlByCtrlClass(WindowHandle instance, string ctrlName, int selectedIndex)
        {
        ...
        private bool Filter(IntPtr handle, string ctrlName)
        {
            ...
            Win32.GetClassName(handle, title, 100);// 取类型
